...
class FacialKeypointMeanCenterDataset(DenseDesignMatrix):
    """
    A Pylearn2 Dataset object for accessing the data for the
    Kaggle facial-keypoint-detection contest for the IFT 6266 H13 course.
    """
    ...
    def __init__(self, which_set,
        ...
        super(FacialKeypointMeanCenterDataset, self).__init__(X=X, y=y, view_converter=view_converter)
    ...
    def get_test_set(self):
        return FacialKeypointMeanCenterDataset(**self.test_args)
